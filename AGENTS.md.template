...
- If Canvas/Experience Builder is available and a homepage, landing page, campaign page, splash page, or presentation-heavy about page is source-like composition, the rebuilt public route should be owned by Canvas/Experience Builder unless the structured route decision proves another Drupal-native owner is better and a fresh blind reviewer prosecutes and accepts that comparison.
