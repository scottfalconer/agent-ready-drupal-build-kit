...
Contributions should preserve the kit's claim discipline.
...
- Add or update claim boundaries when adding a new workflow, template, or evidence type.
- Prefer `UNKNOWN` over guessing.
- Separate generated packets from accepted launch evidence.

## Review Bar

A contribution should make the kit easier for agents to use without making it easier for agents to overclaim.
