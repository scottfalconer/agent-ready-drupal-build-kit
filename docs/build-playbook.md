...
This gate is deliberately limited to inventory/capability reconciliation, representative route matching and anonymous access, and config-schema validation. It does not run PHP syntax checks, coding standards, static analysis, cacheability or mutable-identity probes, or discovered tests; those remain separate evidence needed to satisfy the full custom-code quality issue.
