...
14. Run independent verification and, from the target Drupal project workspace, `node ../agent-ready-drupal-build-kit/bin/verify-packet.mjs --packet review-packet`.
