...
- Actual composition ownership must match the declaration for machine completion. A target-bound deviation with recorded attribution and evidence remains a diagnostic human-review record; local attribution is self-attested and cannot waive the mismatch. Rendered SEO `not_applicable` requires reviewed rationale and evidence.
