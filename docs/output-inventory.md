...
- `G-MEDIA-01`: reconcile reachable source assets to managed Media, genuine external-provider ownership, or item-level blockers. Unresolved assets, incompatible role assignments, and unexplained duplicate placements block completion.
