...
- Complete `negative-route-consent.json`: declare access walls, legal/privacy scope, active consent managers/applications, controlled resources, and fresh before-consent browser evidence for every primary route. A rendered broken legal/privacy link is agent-resolvable; it cannot be waived as production-only.
